        ...
        <ul>
          ...
          <li className="mb-2">
            <button
              ...
              className={`flex items-center justify-between space-x-3 p-2 rounded-md w-full ${
                boardsOpen ? "bg-blue-100 text-blue-700 font-semibold" : "text-gray-700 hover:bg-blue-50 cursor-pointer"
              }`}
            >
            ...
            {boardsOpen && (
              <ul className="ml-8 mt-1 text-sm space-y-1">
                <li>
                  <a href="#" className="block p-1 text-gray-600 hover:text-blue-600">Create routes</a>
                </li>
                <li>
                  <a href="#" className="block p-1 text-gray-600 hover:text-blue-600">Development React App</a>
                </li>
                <li>
                  <a href="#" className="block p-1 font-semibold text-blue-700">Sport XI Project</a>
                </li>
                <li>
                  <a href="#" className="block p-1 text-gray-600 hover:text-blue-600">WordPress theme</a>
                </li>
              </ul>
            )}
          </li>
